    ...
    <form method="POST" action="{{ route('login') }}">
      ...
      <div class="form"  style="width:400px">
        <div class="control">
          ...
          <input id="username" type="username" placeholder="Username" class="form-control{{ $errors->has('username') ? ' is-invalid' : '' }}" name="username" value="{{ old('username') }}" required autocomplete="username" autofocus>
